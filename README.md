...
Proyek dalam repository ini sepenuhnya dibangun menggunakan ekosistem bahasa pemrograman Python 3. Library utama yang saya gunakan meliputi:
   ...
   2. NumPy: Untuk komputasi numerik dan kalkulasi array matematis.
   3. Matplotlib & Seaborn: Untuk merancang visualisasi data dan grafik statistik yang elegan.
   4. Scikit-Learn (sklearn): Pustaka andalan untuk Machine Learning, pemisahan data, kalkulasi metrik error, dan standardisasi (preprocessing).
   5.  Requests: Untuk mengakses REST API eksternal.
  
5. Cara Menjalankan Notebook
    Menggunakan Google Colab :
    1. Buka Google Colab.
    2. Tulis Langsung kode di Terminal
    3. Jalankan kode (sel) dari atas ke bawah.
  
6. Kesimpulan Perjalanan Belajar
